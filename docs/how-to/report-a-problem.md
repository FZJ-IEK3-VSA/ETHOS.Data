...
Replace the package and collection names below with yours.
...
not resolve those per-command overrides or inspect a package's pin. `list`
prints the actual selected catalogue. Verification reads data without repairing it.
