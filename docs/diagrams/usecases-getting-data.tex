...
\node[cmd, right=13mm of see, align=left]   (c1)
  {ice2-data list\\ice2-data info \textit{name}};
\node[cmd, right=13mm of where, align=left] (c2)
  {ice2-data config show\\ice2-data config set-cache \textit{dir}};
\node[cmd, right=13mm of get, align=left]   (c3)
  {ice2-data plan \textit{name}\\ice2-data fetch \textit{name}};
\node[cmd, right=13mm of trust, align=left] (c4)
  {ice2-data verify --all\\ice2-data verify --deep --repair};
\node[cmd, right=13mm of own, align=left]   (c5)
  {ice2-data materialize \textit{dataset}};
...
\node[cmd, right=13mm of inplace, align=left] (c6)
  {ice2-data config set-root \textit{ds dir}};
