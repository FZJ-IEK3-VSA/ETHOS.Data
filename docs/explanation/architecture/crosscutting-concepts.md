...
| Integrity | Download-managed files are hash-checked; ordinary in-place access checks existence; explicit verification serves a separate purpose | [Runtime View](runtime.md#61-data-request); [verify and repair](../../how-to/verify-and-repair.md) |
