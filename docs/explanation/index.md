...
These pages explain why `ethos-data` behaves as it does. Choose the view that
matches what you need to understand:

| Guide | Start here when… |
|---|---|
| [Data concepts](data-concepts.md) | You want to understand collections, caches, access, metadata, and reproducibility without reading the implementation architecture |
